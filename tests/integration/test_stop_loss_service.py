...
@pytest.mark.asyncio
async def test_stop_loss_disabled_noops_even_when_trigger_would_fire(tmp_path) -> None:
    settings = Settings(
        database_url=f"sqlite+aiosqlite:///{tmp_path}/stop_loss_disabled.db",
        app_color="blue",
    ...
    async with session_factory() as session:
        ...
        await repo.upsert_position(
            market_ticker="KXHIGHTSFO-26APR23-T69",
        ...
        await repo.upsert_market_state(
            "KXHIGHTSFO-26APR23-T69",
            kalshi_env=settings.kalshi_env,
            snapshot={"market_ticker": "KXHIGHTSFO-26APR23-T69"},
