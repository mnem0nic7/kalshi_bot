...
| 7 | Contract price floor | contract price < `risk_min_contract_price_dollars` (0.50) — market pricing it as too weak for live entry |
...
| `RISK_MIN_CONTRACT_PRICE_DOLLARS` | 0.50 | Hard block if the traded side costs less than 50¢ |
