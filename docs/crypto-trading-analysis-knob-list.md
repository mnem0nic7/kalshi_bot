...
| `crypto_late_sure_thing_near_strike_momentum_guard_enabled` | `True` | bool | Compare standard late entries with and without the near-strike adverse-momentum guard. |
| `crypto_late_sure_thing_near_strike_max_moneyness_pct` | `0.0001` | pct | Percent distance to strike treated as near-strike. |
| `crypto_late_sure_thing_near_strike_min_probability` | `0.90` | probability | Required model probability when near-strike momentum points against the selected side. |
| `crypto_late_sure_thing_reversal_guard_enabled` | `True` | bool | Compare extended-window late entries with and without adverse-momentum blocking. |
| `crypto_late_sure_thing_reversal_guard_min_seconds_to_close` | `181` | seconds | Start point for the extended-window reversal guard. |
...
| `crypto_late_sure_thing_near_strike_max_moneyness_pct` | `0.00005`, `0.0001`, `0.0002` |
| `crypto_late_sure_thing_near_strike_min_probability` | `0.90`, `0.92`, `0.95` |
