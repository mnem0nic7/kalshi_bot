...
class Settings(BaseSettings):
    ...
    crypto_replay_per_price_bucket_gate_enabled: bool = True
    crypto_replay_per_price_bucket_min_samples: int = 40
    crypto_replay_per_price_bucket_min_win_rate: float = 0.45
    crypto_replay_per_price_bucket_min_net_pnl_dollars: float = 0.0
    ...
    crypto_spot_gemini_enabled: bool = True
    ...
    crypto_btc15m_touch20_stop_loss_pct: float = 0.30
    ...
    risk_min_contract_price_dollars: float = 0.35
