...
def _crypto_policy_values(policy: RuntimeCryptoPolicy) -> dict[str, Any]:
    return {
        "entry": {
            ...
            "target_position_pct": policy.target_position_pct,
        },
        "replay": {
            ...
            "min_pnl_per_candidate_dollars": policy.replay_min_pnl_per_candidate_dollars,
...
def _best_crypto_asset_candidate(
    ...
    *,
    ...
    for field, values in {
        ...
        "max_spread_bps": (100, 250, 500, 800, 1000, 1500),
