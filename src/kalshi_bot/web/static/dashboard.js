(function () {
  ...
  const ROOM_DECISION_EXPORT_COLUMNS = [
    ...
    ["bootstrap_size_factor", "bootstrap_size_factor"],
    ["bootstrap_confidence_source", "bootstrap_confidence_source"],
    ["bootstrap_fair_value_source", "bootstrap_fair_value_source"],
    ["bootstrap_cap_applied", "bootstrap_cap_applied"],
    ["bootstrap_evidence_source", "bootstrap_evidence_source"],
    ["bootstrap_lineage_id", "bootstrap_lineage_id"],
    ["bootstrap_policy_key", "bootstrap_policy_key"],
    ["bootstrap_rollout_state", "bootstrap_rollout_state"],
    ["active_policy_pack_version", "active_policy_pack_version"],
    ["policy_key", "policy_key"],
    ["fallback_policy_key_used", "fallback_policy_key_used"],
    ["gate_thresholds_used", "gate_thresholds_used"],
    ["capital_thresholds_used", "capital_thresholds_used"],
    ["model_policy_version", "model_policy_version"],
    ["binding_policy_lane", "binding_policy_lane"],
    ["policy_disagreement", "policy_disagreement"],
    ["counterfactual_parent_policy_decision", "counterfactual_parent_policy_decision"],
    ["why_allowed_or_blocked", "why_allowed_or_blocked"],
