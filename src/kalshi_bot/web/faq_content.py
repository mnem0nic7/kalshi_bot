        ...
        "items": [
            ...
            },
            {
                ...
                "answer": [
                    ...
                    "The default operating model is now a rolling one-year pipeline: bootstrap the last 365 settled days ending yesterday in resumable chunks, then run a daily incremental refresh that only processes newly settled or newly replayable market-days before rerunning intelligence and confidence.",
                ],
            ...
            },
            {
                ...
                "answer": [
                    ...
                    "Historical status now also tells you whether days are promotable to full coverage, only promotable to partial or late-only coverage, or effectively outcome-only with current sources, and it shows explicit progress toward the 60 execution-day, 30 full-day, and 7 holdout-day confidence thresholds.",
                    "Settlement mismatch reporting is more specific now too: threshold_edge_strictness means a strict > or < exact-threshold edge case, daily_summary_disagreement means Kalshi and NOAA/NCEI still disagree after correct operator handling, and crosscheck_missing means there was no usable daily-summary crosscheck.",
                    "Weather archive repair can also promote already-valid as-of weather bundles into checkpoint-archive records for the exact checkpoint slot when that can be done without using future data. That lets checkpoint coverage catch up to real source support without inventing history.",
            ...
            },
            {
                ...
                "answer": [
                    ...
                    "Settlement crosscheck refresh is also part of normal historical maintenance now. If strict threshold semantics or mismatch classification change, refresh the rolling replay corpus and overlapping historical builds so readiness stays tied to current truth.",
